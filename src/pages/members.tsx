...
const Members = () => {
  ...
  useEffect(() => {
    ...
    socket.on(TRIGER_MEMBER_INSERTED, insertedMember)
    socket.on(TRIGER_MEMBER_DELETED, removedMember)
    socket.on(TRIGER_MEMBER_UPDATED, updatedMember)
    ...
    return () => {
      ...
      socket.off(TRIGER_MEMBER_INSERTED)
      socket.off(TRIGER_MEMBER_DELETED)
      socket.off(TRIGER_MEMBER_UPDATED)
    }
  }, [])
